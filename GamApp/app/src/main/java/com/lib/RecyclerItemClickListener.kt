...
class RecyclerItemClickListener(context: Context?, recyclerView: RecyclerView, private val itemClickListener: OnItemClickListener?) : OnItemTouchListener {
    ...
    override fun onInterceptTouchEvent(view: RecyclerView, e: MotionEvent): Boolean {
        val mChildView: View? = view.findChildViewUnder(e.x, e.y)
